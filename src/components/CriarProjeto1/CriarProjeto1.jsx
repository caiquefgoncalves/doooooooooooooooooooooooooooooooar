            ...
            <div className={css.formulario}>
                <div className={css.linha}>
                    <div className={css.campos}>
                        ...
                        <Select label={'Tipo de ajuda'} input={tipoAjuda} alterarInput={(e) => setTipoAjuda(e.target.value)} options={['Escolha um tipo', 'Dinheiro', 'Alimentos', 'Roupas', 'Voluntariado', 'Outros']} />
